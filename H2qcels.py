...
for l in range(len(target)):
    ...
    for k in range(samples):
        ...
        for i in range(J):
            ...
            sim = qcels(N,Ns,W_trot,Usp,3,rep,target[l]);
            z = sim[0]
            if (i==0):
...
plt.xlabel("T Max")
plt.grid()
plt.legend(["Sim","Target Error"])
#plt.savefig(r'C:\Users\jsnel\Desktop\SummerProject23\Code\Figures\H2qcelsp75_Tmax.png')
...
plt.grid()
plt.legend(["Sim","Target Error"])
#plt.savefig(r'C:\Users\jsnel\Desktop\SummerProject23\Code\Figures\H2qcelsp75_Ttot.png')
